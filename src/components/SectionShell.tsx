...
export function SectionShell({ 
  ...
  return (
    <section className={`mx-auto flex w-full max-w-7xl flex-col px-4 py-20 sm:px-6 lg:px-8 ${className}`}>
      ...
      <div className={align === "center" ? "mx-auto max-w-3xl text-center" : "max-w-3xl"}>
        ...
        <h2 className="text-3xl font-semibold tracking-tight font-[Patrick] sm:text-4xl">
          {title.includes('✦') ? (
        ...
        {description ? (
          <p className="mt-6 text-lg leading-8 text-[#f7f2e9]/60 font-light">
            {description}
          </p>
        ) : null}
      </div>
      ...
      <div className="relative mt-12">
        <div className="absolute left-0 right-0 top-1/2 h-px bg-gradient-to-r from-transparent via-[#c9ac6a] to-transparent" />
